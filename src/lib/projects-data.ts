...
export const allProjects: ProjectData[] = [
  ...
  },
  {
    ...
    year: "Ongoing",
    status: "active",
    highlight: "Exclusive gated living featuring 5–6 bedroom estate homes on 44 private acres in Suwanee",
    summary:
    ...
    highlightsList: [
      ...
      "5–6 bedroom open-concept estate floor plans designed by award-winning architects",
    ],
    floorPlansDetails: [
      {
