...
export function CommunityDetails() {
  return (
    <section className="relative bg-[#160E0A] overflow-hidden min-h-0 md:min-h-[65svh] flex items-center py-16 md:py-24 lg:py-32">
      {/* BG */}
      ...
      <div className="relative z-[2] w-full px-6 sm:px-8 md:px-12 lg:px-20 xl:px-24 2xl:px-32">
        <div className="grid grid-cols-12 gap-8 md:gap-12 items-center">
          ...
          <div className="col-span-12 lg:col-span-6 text-center lg:text-left">
            ...
            <SectionHeadline
              size="xl"
              className="mb-7 text-white responsive-headline-xl"
            >
            ...
            <div className="flex flex-col items-center lg:items-start gap-3 mb-8">
              <div className="flex items-center gap-3">
                <MapPin className="text-[#D43F33] w-[16px] h-[16px]" strokeWidth={1.5} />
                <Annotation className="!text-[#F5F0E8]/65 !font-medium responsive-stat-label">
                  Suwanee, Georgia
                </Annotation>
              </div>
            </div>
            ...
            <BodyText
              className="!text-white responsive-body-sm max-w-xl mx-auto lg:mx-0 mb-8"
            ...
            <div className="flex flex-nowrap sm:flex-wrap items-center justify-center lg:justify-start gap-2 sm:gap-4 mt-10 w-full">
              <ButtonPrimary
                href="#request-info"
                className="w-1/2 sm:w-auto !h-[50px] sm:!h-[56px] !px-2 sm:!px-10 !text-white flex justify-center text-center !gap-2 sm:!gap-4"
              >
              ...
              <ButtonPrimary
                href="#visit"
                className="w-1/2 sm:w-auto !h-[50px] sm:!h-[56px] !px-2 sm:!px-10 !bg-white/5 border border-white/30 hover:!bg-white/10 !text-white flex justify-center text-center !gap-2 sm:!gap-4"
              >
