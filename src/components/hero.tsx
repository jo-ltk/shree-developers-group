...
export function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto flex min-h-screen max-w-[120rem] flex-col justify-between px-5 pb-8 pt-32 text-primary-foreground sm:px-7 md:pt-28 lg:px-10 lg:pb-10">
