...
export function MarqueeTextSection() {
  return (
    <SectionWrapper className="overflow-hidden !pt-12 !pb-12 md:!pt-16 md:!pb-16" dark={false}>
      <div className="flex items-center justify-center md:justify-between mb-8 md:mb-12">
        <SectionLabel className="mx-auto md:mx-0 text-center">Core Values</SectionLabel>
