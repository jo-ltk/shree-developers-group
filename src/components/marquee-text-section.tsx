...
export function MarqueeTextSection() {
  return (
    <section
      className="bg-primary overflow-hidden px-0 py-12 text-primary-foreground sm:py-14 lg:py-18"
    >
        ...
        {marqueeRows.map((row, index) => {
          ...
          return (
            <div key={`row-${index}`} className="group overflow-hidden whitespace-nowrap">
              <div
                className={cn(
                  "marquee-text-track inline-flex min-w-max items-center gap-[0.28em] uppercase leading-[0.86] tracking-[-0.04em] text-primary-foreground/92 transition-[color,letter-spacing,transform] duration-300 group-hover:text-secondary group-hover:tracking-[-0.025em]",
